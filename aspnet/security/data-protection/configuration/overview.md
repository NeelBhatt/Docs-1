...
<!-- literal_block {"backrefs": [], "ids": ["data-protection-code-sample-application-name"], "dupnames": [], "linenos": false, "names": ["data-protection-code-sample-application-name"], "classes": [], "xml:space": "preserve", "language": "c#", "highlight_args": {}} -->
